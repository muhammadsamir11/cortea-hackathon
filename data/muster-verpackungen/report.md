...
Generated 2026-02-04T00:00:00.000Z · model: gpt-4.1
...
## Detected — pending independent review (0)
...
**Tribunal:** confirmed — The allegation is that segregation of duties was bypassed in the creation of and payments to Ratio Consulting GmbH, as the same user (MV-U05) created the vendor, posted all invoices and payments, with no evidence of goods receipt or fulfillment to justify the payments. The defense acknowledges the same facts, provides no documentary evidence of controls, overrides, or mitigating circumstances, and all cited documents confirm both the risk and that relevant duties should have been segregated. There is no evidence of credit notes, secondary review, or other compensating controls. Therefore, the breach of segregation of duties is confirmed per the available evidence.

---

### 8 December costs omitted from the 2025 close

*cutoff_failure · tier: proven · severity: high · amount: EUR 192,000.00*
...
**Tribunal:** confirmed — The evidence strongly supports the allegation: 8 invoices relating to December 2025 services were all booked in January 2026, with December 2025 goods receipts showing the costs appropriately relate to 2025 but remained open (unmatched). No 2025 entries or accruals exist for these expenses, and there is no indication of offsetting credit notes, timing, or FX differences. Supporting documentation confirms that such omissions require explicit correction, which has not occurred. Thus, EUR 192,000 of 2025 expense was omitted, resulting in profit overstatement. The defense provides no substantive refutation and the evidence for omission is clear and internally consistent.

---

### Castor Papier GmbH: 4 same-day payments split below the EUR 10000 approval threshold

*threshold_avoidance · tier: proven · severity: high · amount: EUR 39,040.00*
...
**Tribunal:** confirmed — The defense concedes there is no documented innocent business explanation for the four payments, each just below the EUR 10,000 approval threshold and occurring on the same day to the same creditor, under a single reference. The cited internal control (K5) in the JET workpaper specifically flags such splitting as a risk for threshold avoidance. No evidence is provided of operational necessity, credit notes, foreign currency effects, or related mitigating factors. As all submitted evidence is consistent with the allegation and the defense is not supported by documentation, the allegation is confirmed.

## Requires auditor judgment (1)

### 6 repair and maintenance costs capitalized as fixed assets

*capitalized_repairs · tier: judgment · severity: high · amount: EUR 150,800.00*
...
**Tribunal:** needs-judgment — The evidence from the fixed-asset register (Anlagen!r.192, r.194, r.196) supports that at least some of the capitalized items are major overhauls or replacements ('Austausch Hydraulikaggregat Presse 3', 'Austausch Antriebssteuerung Palettierer', 'Generalüberholung Stanzautomat'), which under German GAAP can indeed be capitalized if they extend useful life or enhance capacity. However, the categorization as repair versus capitalizable improvement cannot be definitively settled without technical documentation or invoices showing the scope and nature of the work performed. The remaining entries (including those labeled 'Reparatur') may not meet capitalization criteria unless similar substantiation is available. Thus, the defense provides plausible business rationale but does not fully neutralize the allegation, nor is the capitalization confirmed indisputably inappropriate based on present evidence. Judgment requires further review of transaction-level support.
