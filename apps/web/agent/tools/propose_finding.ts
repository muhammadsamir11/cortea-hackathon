...
export default defineTool({
  ...
  async execute({ dossier, title, narrative, fraudType, severity, amountInvolved, citations }) {
    const verified = citations.filter((citation) => verifyCitation(dossier, citation));
